...
import { ArrowRight, CheckCircle, Mail, Phone, MapPin, MessageSquare, Clock, Globe, Building2 } from 'lucide-react';
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid lg:grid-cols-3 gap-8 mb-20">
                        ...
                        <div className="bg-white p-8 rounded-3xl border border-slate-100 shadow-lg hover:-translate-y-2 transition-transform duration-300">
                            ...
                            <a href="tel:+919050583365" className="text-lg font-bold text-[#1D2B4F] hover:underline">+91 9050583365</a>
                        </div>
                    </div>
